...
HTTPSTATUSMESSAGES = {
                   400: "The server did not recognise the command",
                   401: "The server doesn't recognise you.",
                   403: "You aren't qualified to get access to this service",
                   404: "The resource you asked for doesn't exist.",
                   418:  "I'm sorry kind sir, I can't offer you tea!",
                   500: "There was an error in a process inside the server"
                      }
...
def connect_to_route(route_url, server_address, input_list=None):
    """
...
def worker_task_calc():
    ...
    try:
        ...
        print("Computer no' " + str(ID) + " finished its work!")
